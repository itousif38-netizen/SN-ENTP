...
import { Database, Download, Upload, AlertTriangle, CheckCircle2, FileJson, HardDrive } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="bg-white p-8 rounded-xl shadow-sm border border-slate-200 flex flex-col items-center text-center animate-fade-in-up">
          ...
          <div className="bg-blue-50 p-4 rounded-lg text-xs text-blue-800 text-left mb-6 w-full">
            <p className="font-bold flex items-center gap-2 mb-1"><HardDrive size={14}/> How to save to Disk E:</p>
            <ol className="list-decimal ml-4 space-y-1">
                <li>Click the button below.</li>
                <li>When the <strong>"Save As"</strong> window pops up, click <strong>"This PC"</strong> on the left.</li>
                <li>Select <strong>"Local Disk (E:)"</strong>.</li>
                <li>Click Save.</li>
            </ol>
            <p className="mt-2 italic opacity-75">* If the file downloads automatically to "Downloads", please move it to Drive E manually.</p>
          </div>

          <button 
            onClick={handleExport}
            className="bg-blue-600 text-white px-6 py-3 rounded-lg font-medium hover:bg-blue-700 shadow-lg shadow-blue-900/20 flex items-center gap-2 transition-transform hover:scale-105 active:scale-95 w-full justify-center"
          >
            <FileJson size={20} /> Download Backup File
          </button>
        </div>
        ...
        <div className="bg-white p-8 rounded-xl shadow-sm border border-slate-200 flex flex-col items-center text-center animate-fade-in-up" style={{animationDelay: '100ms'}}>
          ...
          <button 
             ...
             className="bg-orange-600 text-white px-6 py-3 rounded-lg font-medium hover:bg-orange-700 shadow-lg shadow-orange-900/20 flex items-center gap-2 transition-transform hover:scale-105 active:scale-95 w-full justify-center"
          >
            <Upload size={20} /> Upload Backup File
          </button>
          
          <div className="mt-8 flex items-center gap-2 text-xs text-red-500 bg-red-50 px-3 py-2 rounded-lg border border-red-100 w-full justify-center">
             <AlertTriangle size={16} />
             <span>Warning: Importing will replace all current data!</span>
          </div>
        </div>
      </div>
